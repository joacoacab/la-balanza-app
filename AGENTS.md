...
App B2B para carnicerías argentinas. Calcula el precio mínimo y sugerido de venta por corte en base al precio de compra de la media vaca, el rendimiento por corte, y el descarte (hueso y grasa).
...
- Compra (entrada de media vaca, cálculo de costo)
