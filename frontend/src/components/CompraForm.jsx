...
const DEFAULTS_POR_ANIMAL = {
  vaca:   { porcentaje_carne: '80', porcentaje_hueso: '12', porcentaje_grasa: '8' },
...
const LABEL_PESO = {
  vaca:   'Peso media vaca (kg)',
  cerdo: 'Peso media vaca (kg)',
...
function getDefaults(tipoAnimal) {
  return {
    ...
    peso_media_res: '',
    precio_grasa: '0',
    ...DEFAULTS_POR_ANIMAL[tipoAnimal] ?? DEFAULTS_POR_ANIMAL.vaca,
  }
}

export default function CompraForm({ onSubmit, loading, serverError, tipoAnimal = 'vaca' }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <label
          ...
          className="block text-sm font-medium text-gray-700 mb-1"
        >
          {LABEL_PESO[tipoAnimal] ?? LABEL_PESO.vaca}
        </label>
        <input
          id="peso_media_res"
          type="number"
